 ...
 <div class="container" >
	 <div class="row justify-content-around">
		 ...
		 <div class="col-sm-6 col-lg-3 footer-item">
			 ...
			 <li><a href="TERMS_OF_USE.pdf" target="_blank">Terms &amp; Conditions</a></li>
			 <li><a href="DISCLAIMER_POLICY.pdf" target="_blank">Disclaimer</a></li>
...
text-align: center;display: none;">
    ...
    <form method="post" class="subscribe-form">
		<button class="downloadButton1" id="Ctabtn_footer" type="button" name="dwnldapp_test" onclick="checkAndroidAndDownload1()" style="margin: 10px;">
